...
//     } else{
//         console.log('You are not eligible for delivery')
//     }
// }
// canWeDeliver(85200)
...
const dealReplace = deals.replace('15% Off', '10% Off');
    console.log(dealReplace)
...
const familyDeal = deals.replace('March', 'April')
